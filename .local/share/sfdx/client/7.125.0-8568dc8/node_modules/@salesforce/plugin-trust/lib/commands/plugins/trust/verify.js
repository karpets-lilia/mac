...
class Verify extends command_1.SfdxCommand {
    async run() {
        ...
        const configContext = {
            cacheDir: ts_types_1.get(this.config, 'cacheDir'),
            configDir: ts_types_1.get(this.config, 'configDir'),
            dataDir: ts_types_1.get(this.config, 'dataDir'),
            cliRoot: ts_types_1.get(this.config, 'root'),
        };
