...
class InstallationVerification {
    ...
    async streamTagGz() {
        ...
        try {
            ...
            new npmCommand_1.NpmModule(npmMeta.moduleName, npmMeta.version, this.config.cliRoot).pack(exports.getNpmRegistry().href, {
            ...
            logger.debug(err);
            throw new core_1.SfdxError(err, 'ShellExecError');
        }
        return npmMeta;
    }
