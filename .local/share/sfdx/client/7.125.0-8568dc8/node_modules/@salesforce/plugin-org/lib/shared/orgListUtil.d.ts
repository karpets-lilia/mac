...
export declare class OrgListUtil {
    ...
    static retrieveScratchOrgInfoFromDevHub(devHubUsername: string, orgIdsToQuery: string[]): Promise<Array<Record<ExtendedScratchOrgInfo>>>;
    static reduceScratchOrgInfo(updatedContents: Array<Record<ExtendedScratchOrgInfo>>, orgs: ExtendedAuthFields[]): Promise<ExtendedAuthFields[]>;
    /**
