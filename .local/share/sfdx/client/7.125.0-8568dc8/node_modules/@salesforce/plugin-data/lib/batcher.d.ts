...
import { BatchInfo, BatchResultInfo, JobInfo } from 'jsforce';
...
export declare class Batcher {
    ...
    bulkStatus(summary: JobInfo | BatchInfo, results?: BatchResultInfo[], batchNum?: number, isJob?: boolean): JobInfo | BatchInfo;
    /**
     ...
     * @param wait {number}
     */
    createAndExecuteBatches(job: Job, records: ReadStream, sobjectType: string, wait?: number): Promise<BulkResult[] | JobInfo[]>;
    /**
