        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const parsedLogs = logResults.map(logResult => {
                    const colored = utils_1.colorLogs(logResult.log);
                    this.ux.log(colored);
...
Get.description = utils_1.buildDescription(messages.getMessage('commandDescription'), messages.getMessage('longDescription'));
