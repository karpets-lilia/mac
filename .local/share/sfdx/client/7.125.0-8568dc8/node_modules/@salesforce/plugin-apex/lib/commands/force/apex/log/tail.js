        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (fullLog) {
                if (this.flags.json) {
                    ...
                    const output = this.flags.color ? yield legacyColorization_1.colorizeLog(fullLog) : fullLog;
                    this.ux.log(output);
                }
            }
        });
...
Tail.description = utils_1.buildDescription(messages.getMessage('commandDescription'), messages.getMessage('longDescription'));
