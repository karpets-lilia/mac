...
class Report extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.flags.outputdir) {
                const outputDirConfig = reporters_1.buildOutputDirConfig(result, jsonOutput, this.flags.outputdir, this.flags.resultformat, true);
...
Report.description = utils_1.buildDescription(messages.getMessage('commandDescription'), messages.getMessage('longDescription'));
