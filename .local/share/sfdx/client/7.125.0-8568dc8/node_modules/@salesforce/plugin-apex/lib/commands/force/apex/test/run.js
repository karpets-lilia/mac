        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.flags.synchronous && testLevel === "RunSpecifiedTests" /* RunSpecifiedTests */) {
                ...
                if (this.flags.resultformat !== undefined) {
                    result = yield testService.runTestAsynchronous(payload, this.flags.codecoverage, false, reporter, this.cancellationTokenSource.token);
                }
                else {
                    result = yield testService.runTestAsynchronous(payload, this.flags.codecoverage, true, reporter, this.cancellationTokenSource.token);
                }
            }
