...
const QUERY = 'SELECT Id, SubscriberPackageId, Name, Description, NamespacePrefix, ContainerOptions, IsOrgDependent, ConvertedFromPackageId, PackageErrorUsername ' +
    'FROM Package2 ' +
    ...
    _execute(context) {
        ...
        return this.force.toolingQuery(this.org, QUERY).then((queryResult) => {
            ...
            if (records && records.length > 0) {
                this.results = records.map(({ Id, SubscriberPackageId, Name, Description, NamespacePrefix, ContainerOptions, ConvertedFromPackageId, IsOrgDependent, PackageErrorUsername, }) => {
