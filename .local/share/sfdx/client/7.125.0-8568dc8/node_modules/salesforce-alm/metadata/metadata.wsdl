...
<!--
Salesforce.com Metadata API version 53.0
...
<definitions targetNamespace="http://soap.sforce.com/2006/04/metadata" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://schemas.xmlsoap.org/wsdl/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://soap.sforce.com/2006/04/metadata">
  ...
  <xsd:schema elementFormDefault="qualified" targetNamespace="http://soap.sforce.com/2006/04/metadata">
    ...
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       ...
       <xsd:element name="enableDynamicGaugeChartPref" minOccurs="0" type="xsd:boolean"/>
       ...
       <xsd:element name="enableLwcInDashboards" minOccurs="0" type="xsd:boolean"/>
   ...
   <xsd:complexType name="DataMappingSchema">
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       <xsd:element name="schemaRetriever" type="xsd:string"/>
   ...
   <xsd:complexType name="FederationDataMappingUsage">
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       <xsd:element name="createMapping" type="xsd:string"/>
       ...
       <xsd:element name="updateMapping" type="xsd:string"/>
   ...
   <xsd:complexType name="LoyaltyProgramSetup">
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       <xsd:element name="processes" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcess"/>
      </xsd:sequence>
     </xsd:extension>
    </xsd:complexContent>
   </xsd:complexType>
   <xsd:complexType name="LoyaltyProgramProcess">
    <xsd:sequence>
     <xsd:element name="description" minOccurs="0" type="xsd:string"/>
     <xsd:element name="executionType" type="tns:ProcessExecutionType"/>
     <xsd:element name="journalSubType" minOccurs="0" type="xsd:string"/>
     <xsd:element name="journalType" type="xsd:string"/>
     <xsd:element name="label" minOccurs="0" type="xsd:string"/>
     <xsd:element name="name" type="xsd:string"/>
     <xsd:element name="parameters" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcessParameter"/>
     <xsd:element name="rules" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcessRules"/>
     <xsd:element name="status" type="tns:ProcessStatus"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:simpleType name="ProcessExecutionType">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="RealTime"/>
     <xsd:enumeration value="Batch"/>
    </xsd:restriction>
   </xsd:simpleType>
   <xsd:complexType name="LoyaltyProgramProcessParameter">
    <xsd:sequence>
     <xsd:element name="dataType" type="tns:ProcessParameterDataType"/>
     <xsd:element name="decimalPlaces" minOccurs="0" type="xsd:int"/>
     <xsd:element name="description" minOccurs="0" type="xsd:string"/>
     <xsd:element name="isCollection" minOccurs="0" type="xsd:boolean"/>
     <xsd:element name="isInput" minOccurs="0" type="xsd:boolean"/>
     ...
     <xsd:element name="parameterColumn" minOccurs="0" type="xsd:string"/>
     <xsd:element name="reference" minOccurs="0" type="xsd:string"/>
     <xsd:element name="type" type="tns:ProcessParameterType"/>
     <xsd:element name="value" minOccurs="0" type="xsd:string"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:simpleType name="ProcessParameterDataType">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="Text"/>
   ...
   <xsd:simpleType name="ProcessParameterType">
    <xsd:restriction base="xsd:string">
   ...
   <xsd:complexType name="LoyaltyProgramProcessRules">
    <xsd:sequence>
     <xsd:element name="children" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcessRuleStep"/>
     <xsd:element name="description" minOccurs="0" type="xsd:string"/>
     <xsd:element name="endDate" minOccurs="0" type="xsd:date"/>
     <xsd:element name="label" minOccurs="0" type="xsd:string"/>
     <xsd:element name="name" type="xsd:string"/>
     <xsd:element name="nextProcessRule" minOccurs="0" type="xsd:string"/>
     <xsd:element name="promotion" minOccurs="0" type="xsd:string"/>
     <xsd:element name="startDate" minOccurs="0" type="xsd:date"/>
     <xsd:element name="status" type="tns:ProcessRuleStatus"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:complexType name="LoyaltyProgramProcessRuleStep">
    <xsd:sequence>
     <xsd:element name="action" minOccurs="0" type="tns:LoyaltyProgramProcessRuleAction"/>
     <xsd:element name="children" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcessRuleStep"/>
     <xsd:element name="filter" minOccurs="0" type="tns:LoyaltyProgramProcessRuleFilter"/>
     <xsd:element name="name" type="xsd:string"/>
     <xsd:element name="priority" type="xsd:int"/>
     <xsd:element name="type" type="tns:ProcessRuleType"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:complexType name="LoyaltyProgramProcessRuleAction">
    <xsd:sequence>
     <xsd:element name="actionParameters" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcessRuleActionParameter"/>
     <xsd:element name="actionType" type="tns:ProcessRuleActionType"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:complexType name="LoyaltyProgramProcessRuleActionParameter">
    <xsd:sequence>
     <xsd:element name="name" type="xsd:string"/>
     <xsd:element name="value" type="xsd:string"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:simpleType name="ProcessRuleActionType">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="CreditPoints"/>
     <xsd:enumeration value="CancelAccrual"/>
     <xsd:enumeration value="RedeemPoints"/>
     <xsd:enumeration value="CancelRedeem"/>
     <xsd:enumeration value="TransferPoints"/>
     <xsd:enumeration value="IssueVoucher"/>
     <xsd:enumeration value="PointBalance"/>
     <xsd:enumeration value="GetMemberTier"/>
     <xsd:enumeration value="UpgradeTier"/>
     <xsd:enumeration value="GetMemberPromotion"/>
     <xsd:enumeration value="IncrementMemberPromotion"/>
     <xsd:enumeration value="ResetMemberPromotion"/>
     <xsd:enumeration value="UpdateParameter"/>
     <xsd:enumeration value="Flow"/>
     <xsd:enumeration value="UpdatePointBalance"/>
    </xsd:restriction>
   </xsd:simpleType>
   <xsd:complexType name="LoyaltyProgramProcessRuleFilter">
    <xsd:sequence>
     <xsd:element name="criteria" minOccurs="0" maxOccurs="unbounded" type="tns:LoyaltyProgramProcessRuleFilterCriteria"/>
     <xsd:element name="filterCondition" type="xsd:string"/>
     <xsd:element name="filterExpression" minOccurs="0" type="xsd:string"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:complexType name="LoyaltyProgramProcessRuleFilterCriteria">
    <xsd:sequence>
     <xsd:element name="dataType" type="tns:ProcessParameterDataType"/>
     <xsd:element name="operator" type="tns:ProcessRuleConditionOperator"/>
     <xsd:element name="sequence" type="xsd:int"/>
     <xsd:element name="sourceFieldName" type="xsd:string"/>
     <xsd:element name="value" minOccurs="0" type="xsd:string"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:simpleType name="ProcessRuleConditionOperator">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="Equals"/>
     <xsd:enumeration value="NotEquals"/>
     <xsd:enumeration value="GreaterThan"/>
   ...
   <xsd:simpleType name="ProcessRuleType">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="Condition"/>
     <xsd:enumeration value="Action"/>
    </xsd:restriction>
   </xsd:simpleType>
   <xsd:simpleType name="ProcessRuleStatus">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="Draft"/>
     <xsd:enumeration value="Active"/>
     <xsd:enumeration value="Inactive"/>
   ...
   <xsd:simpleType name="ExtendedErrorCode">
    <xsd:restriction base="xsd:string">
     ...
     <xsd:enumeration value="ASSIGNEE_AUTOPROC">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="ASSIGNEE_MISSING">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity</xsd:documentation></xsd:annotation></xsd:enumeration>
     ...
     <xsd:enumeration value="CHOICE_USED_MULTIPLE_TIMES_IN_SAME_FIELD">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, choiceName</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="COLLECTION_MAP_ITEMS_MISSING">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     ...
     <xsd:enumeration value="COLLECTION_PROCESSOR_INVALID_CONFIGURATION">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="COLLECTION_PROCESSOR_INVALID_CURRENT_VALUE">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="COLLECTION_PROCESSOR_INVALID_OUTPUT_TABLE">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     ...
     <xsd:enumeration value="COLLECTION_PROCESSOR_MISSING_MAP">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="COLLECTION_PROCESSOR_MISSING_MAP_ITEM">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="COLLECTION_PROCESSOR_MISSING_OUTPUT_TABLE">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity, elementName</xsd:documentation></xsd:annotation></xsd:enumeration>
     ...
     <xsd:enumeration value="UNEXPECTED_ERROR">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity</xsd:documentation></xsd:annotation></xsd:enumeration>
     <xsd:enumeration value="USER_INVALID">
      <xsd:annotation>
       <xsd:documentation>Errors with this extended error code have the following properties: erroneousElementApiName, erroneousElementType, erroneousFields, severity</xsd:documentation></xsd:annotation></xsd:enumeration>
   ...
   <xsd:simpleType name="StatusCode">
    <xsd:restriction base="xsd:string">
     ...
     <xsd:enumeration value="ALREADY_IN_CHANNEL"/>
     ...
     <xsd:enumeration value="CANT_INVITE"/>
     <xsd:enumeration value="CANT_INVITE_SELF"/>
     ...
     <xsd:enumeration value="INVALID_NAME_MAXLENGTH"/>
     <xsd:enumeration value="INVALID_NAME_PUNCTUATION"/>
     <xsd:enumeration value="INVALID_NAME_REQUIRED"/>
     <xsd:enumeration value="INVALID_NAME_SPECIALS"/>
     ...
     <xsd:enumeration value="INVITEE_CANT_SEE_CHANNEL"/>
     ...
     <xsd:enumeration value="LIMIT_REQUIRED"/>
     ...
     <xsd:enumeration value="NO_CHANNEL"/>
     ...
     <xsd:enumeration value="ORG_USER_NOT_IN_TEAM"/>
     ...
     <xsd:enumeration value="SEARCHABLE_ATTRIBUTE_LIMIT_EXCEEDED"/>
     ...
     <xsd:enumeration value="SLACK_CANNOT_CREATE_CHANNEL"/>
     ...
     <xsd:enumeration value="TOKEN_EXPIRED"/>
     ...
     <xsd:enumeration value="TOO_MANY_CONVOS_FOR_APP_ON_TEAM"/>
     <xsd:enumeration value="TOO_MANY_CONVOS_FOR_TEAM"/>
     ...
     <xsd:enumeration value="URA_MAX_CHANNELS"/>
     <xsd:enumeration value="USER_DISABLED"/>
     <xsd:enumeration value="USER_IS_RESTRICTED"/>
 ...
 <service name="MetadataService">
  ...
  <port binding="tns:MetadataBinding" name="Metadata">
   <soap:address location="https://login.salesforce.com/services/Soap/m/53.0"/>
  </port>
 </service>
</definitions>
